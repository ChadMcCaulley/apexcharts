  ...
  attrs: {
        ...
        events: {
          ...
          attrs: {
            ...
            dataPointSelection: {
              ...
              url: 'https://apexcharts.com/docs/options/chart/events/#dataPointSelection',
              default(event, chartContext, config) {},
            },
            dataPointMouseEnter: {
              title:
                'Fires when user’s mouse enter on a datapoint (bar/column/marker/bubble/donut-slice)',
              url: 'https://apexcharts.com/docs/options/chart/events/#dataPointMouseEnter',
              default(event, chartContext, config) {},
            },
            dataPointMouseLeave: {
              title:
            ...
            beforeZoom: {
              ...
              url: 'https://apexcharts.com/docs/options/chart/events/#beforeZoom',
            ...
            beforeResetZoom: {
              ...
              url: 'https://apexcharts.com/docs/options/chart/events/#beforeResetZoom',
            ...
            tools: {
              ...
              attrs: {
                download: {
                  ...
                  url: 'https://apexcharts.com/docs/options/chart/toolbar/#download',
                  type: Boolean,
                  default: true,
                },
                selection: {
                  ...
                  url: 'https://apexcharts.com/docs/options/chart/toolbar/#selection',
                  type: Boolean,
                  default: true,
                },
                zoom: {
                ...
                customIcons: {
                  ...
                  url: 'https://apexcharts.com/docs/options/chart/toolbar/#customIcons',
                  default: [],
                },
              },
            },
    ...
    legend: {
      ...
      attrs: {
        ...
        tooltipHoverFormatter: {
          ...
          url: 'https://apexcharts.com/docs/options/legend/#tooltipHoverFormatter',
          default(seriesName, opts) {
            return (
              seriesName +
              ' - <strong>' +
    ...
    yaxis: {
      ...
      attrs: {
        ...
        tickAmount: {
          title:
            'Number of tick intervals to show. Will be honoured unless it conflicts with your other settings.',
          type: Number,
          default: 6,
        },
        min: {
